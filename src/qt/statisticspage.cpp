...
void StatisticsPage::updateStatistics()
{
    ...
    {
        subsidy = "14100 NXE per block";
    }
    else if(pindexBest->nHeight < 100)
    {
        subsidy = "0 NXE per block";
    }
    else if(pindexBest->nHeight < 7200)
    {
        subsidy = "500 NXE per block";
    }
    else if(pindexBest->nHeight < 14000)
    {
        subsidy = "250 NXE per block";
    }
    else if(pindexBest->nHeight < 28000)
    {
        subsidy = "125 NXE per block";
    }
    ...
    {
        ui->volumeBox->setText("<b><font color=\"#ebbcff\">" + qVolume + " NXE" + "</font></b>");
    } else if(volume < volumePrevious) {
        ui->volumeBox->setText("<b><font color=\"red\">" + qVolume + " NXE" + "</font></b>");
    } else {
        ui->volumeBox->setText(qVolume + " NXE");
    }
